...
import com.noydb.duhmapper.error.StrictDuhMapException;
...
import static com.noydb.duhmapper.kit.DuhMapProcessorUtils.getMismatchingFieldsLog;
...
public final class DuhMapAnnotationValidator {
    ...
    // 1. only interface can be annotated
    // with @DuhMap
    ...
    public static void run(
        ...
        validateInterfaces(processingEnv, roundEnv);
...
//            final var isSpringBean = interfaceAnnotation.beanType().equals(DuhMapClassType.SPRING_BEAN);
